...
var gameModel = function () {
    ...
    this.beginGame = function() {
        ...
        this.leftRail = new rail(this.config.railWidth, (-this.config.paddleStart) + this.config.railSpaceHeight,
            { x: this.config.leftBound , y: ((this.config.paddleStart + this.config.railSpaceHeight)/2), z: 0 });
        this.rightRail = new rail( this.config.railWidth, (-this.config.paddleStart) + this.config.railSpaceHeight,
        { x: this.config.rightBound, y: ((this.config.paddleStart + this.config.railSpaceHeight)/2), z: 0 });
        this.topRail = new rail(this.config.railSpaceWidth + this.config.railWidth, this.config.railWidth,
            { x: (this.config.railSpaceWidth - this.config.railBuffer *2 - this.config.railWidth)/2, y: this.config.railSpaceHeight - this.config.railBuffer, z: 0 });
